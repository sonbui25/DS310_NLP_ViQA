...
5. Tiêu chí cốt lõi là chỉ trả về câu trả lời dưới dạng đoạn văn được trích xuất từ đoạn văn gốc nếu nó có thông tin để trả lời câu hỏi, không cần giải thích hay bình luận thêm gì cả."""
